...
const {nombre, propietario, email, fecha, sintomas} = paciente
    ...
    return (
        <div className="m-3 bg-white shadow-md px-5 py-10 rounded-md">
                ...
                <p className="font-bold mb-3 text-gray-700 uppercase">E-mail:<span className="font-normal normal-case"> {paciente.email}</span></p>
                ...
                <div className="flex justify-between mt-10">
                    <button 
                        type="button" 
                        className="py-2 px-10 bg-indigo-600 hover:bg-indigo-700 text-white font-bold uppercase rounded-sm"
                        onClick={()=> setPaciente(paciente)}
                    >Editar
                    </button>
                
                    <button type="button" className="py-2 px-10 bg-red-600 hover:bg-red-700 text-white font-bold uppercase rounded-sm">Eliminar</button>
                </div>
            </div>
    )
